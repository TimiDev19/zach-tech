...
const Footer = () => {
    return (
        <div>
            <div
                className=' w-full h-[50vh] bg-[#000033] flex items-center justify-between text-white'
            >
                ...
                <div className=' w-[70%] px-[10px] h-full flex items-center justify-between'>
            ...
            <div className=' w-full h-[50px] flex items-center justify-center bg-[#000033] text-white'>
